...
All notable changes to the Posty CLI will be documented in this file.
...
- Environment variable configuration (POSTY_API_KEY, POSTY_API_URL)
- Comprehensive help documentation
- Example scripts for basic usage and AI agent integration
- SKILL.md for AI agent usage patterns

### Features
- Command-line interface for Posty API
